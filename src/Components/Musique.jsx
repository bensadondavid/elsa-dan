...
function Musique(){
  ...
  const srcMusique = '/Musique/kohavim-trim.mp3'

  const PlayIcon = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#857667" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
